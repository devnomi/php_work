...
if (isset($_POST["reg"]))
{
    ...
    $insert = mysqli_query($con,"INSERT INTO form SET
    name ='$name',
    fname ='$fname',
    email = '$email',
    password = '$password'
        		...
        		<div class="panel-heading">
			    		...
			    		<form role="form" action="form.php" method ="post">
			                ...
			                <input type="text" name="name" id="name" class="form-control input-sm" placeholder="Name">
			    				...
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="fname" id="fname" class="form-control input-sm" placeholder="Father Name">
			    					</div>
			    				</div>
			    			</div>
...
-->
			    			...
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="email" name="email" id="password" class="form-control input-sm" placeholder="Email">
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
